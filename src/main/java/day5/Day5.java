...
//        part 1
    ...
    public static int getMovesPart1(int[] input) {
        ...
        while (currentIndex < input.length) {
            ...
            totalMoves++;
            input[previousIndex] = input[previousIndex] + 1;
        }

        return totalMoves;
    }

    public static int getMovesPart2(int[] input) {
        int totalMoves = 0;
        int currentIndex = 0;
